...
class TempBroDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: TempBroStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = TempBroStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class TempBroStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? TempBroDeviceSource else {
...
class TempBroProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: TempBroDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = TempBroDeviceSource(localizedName: "SampleCapture (Swift)")
